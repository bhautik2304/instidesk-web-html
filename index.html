...
<head>
    ...
    <!-- SEO meta tags -->
    <title>Instidesk | Abroad Studies Portal</title>
    <meta name="description" content="Instidesk - Abroad Studies Portal">
    <meta name="keywords"
        content="Instidesk, Abroad Studies">
    <meta name="author" content="Instidesk">
    ...
    <main class="page-wrapper">
        ...
        <header class="navbar navbar-expand-lg fixed-top">
            <div class="container">
                ...
                <a class="btn btn-primary btn-sm fs-sm order-lg-3 d-none d-sm-inline-flex"
                    href="https://play.google.com/store/apps/details?id=com.instidesk&pcampaignid=web_share" target="_blank"
                    rel="noopener">
                    Download now
                </a>
        ...
        <section class="bg-secondary position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
            ...
            <div class="container position-relative z-5 mt-2 pt-5 pb-2 pb-sm-4 pb-lg-5">
                <h1 class="display-3 text-center mx-auto pt-5 my-2 my-sm-4" style="max-width: 800px;">The Only
                    Platform </br> For International Studies</h1>
                ...
                <div class="row justify-content-center pt-3 pt-sm-4 pt-md-5 mt-sm-1">
                    <div class="col-8 col-lg-4 order-lg-2" style="margin-top: -105px;">
                        ...
                        <div class="position-lg-sticky top-0 mb-5 pb-sm-2 pb-xl-4" style="padding-top: 110px;">
                            <img class="d-block mx-auto"
                                src="assets/img/landing/mobile-app-showcase/hero/screen02.png" width="322"
                                alt="App screen">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4 order-lg-1 overflow-hidden mt-lg-4 pt-xl-3">
                        ...
                        <img class="d-none d-lg-block rounded-4 ms-auto"
                            src="assets/img/landing/mobile-app-showcase/hero/screen01.png" width="297"
                            alt="App screen" style="box-shadow: 0 .9375rem 3rem -.5rem rgba(18,34,50, .05);">
                        ...
                        <div class="text-center text-sm-start mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4"
                            ...
                            <div class="d-table bg-dark bg-opacity-10 rounded-1 p-2 mx-auto mx-sm-0 mb-3 mb-lg-4">
                                <svg class="d-block m-1 text-warning" width="24" height="24"
                            ...
                            <h2 class="h4 text-white mb-2 mb-lg-3">Access all International Courses</h2>
                        ...
                        <div class="text-center text-sm-start mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4"
                            style="max-width: 340px;" data-aos="fade-right" data-aos-delay="200"
                            data-aos-offset="250" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                            <div class="d-table bg-dark bg-opacity-10 rounded-1 p-2 mx-auto mx-sm-0 mb-3 mb-lg-4">
                                <svg class="d-block m-1 text-warning" width="24" height="24"
                                    viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <h2 class="h4 text-white mb-2 mb-lg-3">Explore all International Colleges</h2>
                    ...
                    <div class="col-sm-6 col-lg-4 order-lg-3 overflow-hidden mt-lg-4 pt-xl-3">
                        ...
                        <img class="d-none d-lg-block rounded-4"
                            src="assets/img/landing/mobile-app-showcase/hero/screen03.png" width="297"
                            alt="App screen" style="box-shadow: 0 .9375rem 3rem -.5rem rgba(18,34,50, .05);">
                        ...
                        <div class="text-center text-sm-start mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4"
                            style="max-width: 340px;" data-aos="fade-left" data-aos-offset="250"
                            data-aos-delay="400" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                            <div class="d-table bg-dark bg-opacity-10 rounded-1 p-2 mx-auto mx-sm-0 mb-3 mb-lg-4">
                                <svg class="d-block m-1 text-warning" width="24" height="24"
                                    viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <h2 class="h4 text-white mb-2 mb-lg-3">Easy Course Finder</h2>
                        ...
                        <div class="text-center text-sm-start mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4"
                            style="max-width: 340px;" data-aos="fade-left" data-aos-offset="200"
                            data-aos-delay="600" data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                            <div class="d-table bg-dark bg-opacity-10 rounded-1 p-2 mx-auto mx-sm-0 mb-3 mb-lg-4">
                                <svg class="d-block m-1 text-warning" width="24" height="24"
                                    viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M19.9524 20.9857C17.8306 22.8676 15.057 24 12.0132 24C5.38642 24 0 18.6128 0 11.985C0 5.60651 4.98548 0.379975 11.2624 0V5.02678C7.74852 5.39775 5.005 8.38048 5.005 11.985C5.005 15.8493 8.14795 18.9942 12.0132 18.9942C13.6755 18.9942 15.2072 18.413 16.4085 17.4428L19.9524 20.9857Z">
                                    </path>
                                    <path
                                        d="M24.0042 12.7358C23.8436 15.4797 22.7534 17.9818 21.0205 19.9253L17.4766 16.3808C18.298 15.3701 18.8386 14.1085 18.9782 12.7358H24.0042Z">
                                    </path>
                                    <path
                                        d="M23.998 11.234H18.9719C18.6311 7.97046 16.0287 5.36621 12.7656 5.02678V0C18.7917 0.360451 23.6376 5.20701 23.998 11.234Z">
                                    </path>
                                </svg>
                            </div>
                            <h2 class="h4 text-white mb-2 mb-lg-3">Track Student Addmision Application</h2>
        ...
        <section class="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
            <div class="row pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-xxl-2 mt-md-3 mt-lg-0">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="h2 text-center text-lg-start pb-md-2 pb-xl-0 mb-4 mb-xl-5">Increase your reach and gain
                        access to hundreds of abroad colleges and universities in one application.</div>

                    <!-- Market buttons -->
                    <div class="d-flex justify-content-center justify-content-lg-start">
                        <a class="btn btn-dark btn-lg px-3 py-2 me-3" href="#">
                            <img class="d-dark-mode-none mx-1" src="assets/img/market/appstore-light.svg"
                                width="136" alt="App Store">
                            <img class="d-none d-dark-mode-block mx-1" src="assets/img/market/appstore-dark.svg"
                                width="136" alt="App Store">
                        </a>
                        <a class="btn btn-dark btn-lg px-3 py-2" href="https://play.google.com/store/apps/details?id=com.instidesk&pcampaignid=web_share">
                            <img class="d-dark-mode-none mx-1" src="assets/img/market/googleplay-light.svg"
                                width="135" alt="Google Play">
                            <img class="d-none d-dark-mode-block mx-1" src="assets/img/market/googleplay-dark.svg"
                                width="135" alt="Google Play">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 g-3 g-md-4">
                        <div class="col">
                            <div class="d-flex flex-column h-100 bg-primary bg-opacity-10 rounded-3 text-center p-4">
                                <div class="h3 display-5 mt-1 mb-0">4,958+</div>
                                <div class="fs-lg mb-1">Students Enrolled</div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-flex flex-column h-100 bg-info bg-opacity-10 rounded-3 text-center p-4">
                                <div class="h3 display-5 mt-1 mb-0">1500+</div>
                                <div class="fs-lg mb-1">College Application per year</div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-flex flex-column h-100 bg-warning bg-opacity-10 rounded-3 text-center p-4">
                                <div class="h3 display-5 mt-1 mb-0">200+</div>
                                <div class="fs-lg mb-1">Agents in all India</div>
                            </div>
                        </div>
                        <div class="col">
                ...
                <div class="col-md-6 pb-2 pb-sm-0 mb-4 mb-sm-5 mb-md-0">
                    ...
                    <div class="binded-content bg-primary rounded-5">
                        ...
                        <div class="binded-item active" id="image1">
                            <svg class="d-block position-absolute top-0 start-0 w-100 h-100 text-warning"
                                width="636" height="640" viewBox="0 0 636 640" fill="currentColor"
                                ...
                                <path
                                    d="M140.2,52.6c-1.2-9-6.2-17.2-12-24c-0.8-0.9-2.1-1-3-0.2c-0.9,0.8-1,2.1-0.2,3c5.3,6.2,10,13.6,11,21.8c0.1,1.2,1.2,2,2.4,1.8C139.5,54.9,140.3,53.8,140.2,52.6z">
                                </path>
                                <path
                                    d="M124.1,72.9c-6.1,0.3-11.5,2-17.2,3.6c-1.1,0.3-1.8,1.5-1.5,2.6c0.3,1.1,1.5,1.8,2.6,1.5c5.5-1.5,10.6-3.1,16.3-3.4c1.2-0.1,2.1-1,2-2.2C126.2,73.7,125.3,72.8,124.1,72.9z">
                                </path>
                                <path
                                    d="M131.5,57.8c-11.4-6.8-25.1-12.4-38.2-15.2c-1.1-0.2-2.3,0.5-2.5,1.6c-0.2,1.1,0.5,2.3,1.6,2.5c12.6,2.8,25.9,8.1,36.9,14.7c1,0.6,2.3,0.3,2.9-0.7C132.8,59.7,132.5,58.4,131.5,57.8z">
                                </path>
                            </svg>
                            <img class="d-block position-relative z-2"
                                src="assets/img/landing/mobile-app-showcase/features/01.png" alt="App screen">
                        </div>
                        ...
                        <div class="binded-item" id="image2">
                            ...
                            <img class="d-block position-relative z-2"
                                src="assets/img/landing/mobile-app-showcase/features/02.png" alt="App screen">
                        </div>
                        ...
                        <div class="binded-item" id="image3">
                            ...
                            <img class="d-block position-relative z-2"
                                src="assets/img/landing/mobile-app-showcase/features/03.png" alt="App screen">
                        </div>

                        <!-- Item -->
                        <div class="binded-item" id="image4">
                            <svg class="d-block position-absolute top-0 start-0 w-100 h-100 text-warning"
                                width="636" height="640" viewBox="0 0 636 640" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <!-- Item -->
                        <div class="binded-item" id="image5">
                            <svg class="d-block position-absolute top-0 start-0 w-100 h-100 text-warning"
                                width="636" height="640" viewBox="0 0 636 640" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                  ...
                  "nextEl": "#next-feature"
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide" data-swiper-binded="#image1">
                                    ...
                                    <h2 class="h1 mb-lg-4">Download app and enroll yourself</h2>
                                ...
                                <div class="swiper-slide" data-swiper-binded="#image2">
                                    ...
                                    <h2 class="h1 mb-lg-4">Search courses and shortlist them</h2>
                                    <p class="mb-0">Odio pellentesque faucibus tortor, sit ac mattis tincidunt magna
                                        sit. Vitae elementum amet etiam rhoncus, lacinia amet interdum pharetra
                                        tincidunt. Ultricies faucibus ac morbi eget nunc pretium id. Velit tristique
                                        scelerisque elit sociis convallis ultricies aliquam.</p>
                                ...
                                <div class="swiper-slide" data-swiper-binded="#image3">
                                    ...
                                    <h2 class="h1 mb-lg-4">Explore college and university</h2>
                                    <p class="mb-0">Odio pellentesque faucibus tortor, sit ac mattis tincidunt magna
                                        sit. Vitae elementum amet etiam rhoncus, lacinia amet interdum pharetra
                                        tincidunt. Ultricies faucibus ac morbi eget nunc pretium id. Velit tristique
                                        scelerisque elit sociis convallis ultricies aliquam.</p>
                                ...
                                <!-- Item -->
                                <div class="swiper-slide" data-swiper-binded="#image4">
                                    <div class="text-primary fs-xl fw-bold mb-3">04</div>
                                    <h2 class="h1 mb-lg-4">We consult and help you to apply for admission in your
                                        preferred college</h2>
                                    <p class="mb-0">Odio pellentesque faucibus tortor, sit ac mattis tincidunt magna
                                        sit. Vitae elementum amet etiam rhoncus, lacinia amet interdum pharetra
                                        tincidunt. Ultricies faucibus ac morbi eget nunc pretium id. Velit tristique
                                        scelerisque elit sociis convallis ultricies aliquam.</p>
                                ...
                                <!-- Item -->
                                <div class="swiper-slide" data-swiper-binded="#image5">
                                    <div class="text-primary fs-xl fw-bold mb-3">05</div>
                                    <h2 class="h1 mb-lg-4">Track your applications</h2>
                                    <p class="mb-0">Odio pellentesque faucibus tortor, sit ac mattis tincidunt magna
                                        sit. Vitae elementum amet etiam rhoncus, lacinia amet interdum pharetra
                                        tincidunt. Ultricies faucibus ac morbi eget nunc pretium id. Velit tristique
                                        scelerisque elit sociis convallis ultricies aliquam.</p>
            ...
            <div class="container pt-3 pt-sm-4 pt-lg-5 mt-md-3 mt-lg-0">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5 col-xl-4 order-md-1">
                        <h2 class="h3 text-center text-md-start mb-4">More than two lakh students migrate to abroad for
                            further studies every year.</br></br> If you are thinking to be one of them ?
                            </br>
                        </h2>
                        Then just install Instidesk and start your abroad journey with us .
                    ...
                    <div class="swiper-slide">
                        <div class="border rounded-4">
                            <img class="d-block d-dark-mode-none mx-auto"
                                src="assets/img/landing/business-consulting/clients/04-dark.svg" width="196"
                                alt="Logo">
                            <img class="d-none d-dark-mode-block mx-auto"
                                src="assets/img/landing/business-consulting/clients/04-light.svg" width="196"
                                alt="Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="border rounded-4">
                            <img class="d-block d-dark-mode-none mx-auto"
                                src="assets/img/landing/business-consulting/clients/01-dark.svg" width="196"
                                alt="Logo">
                            <img class="d-none d-dark-mode-block mx-auto"
                                src="assets/img/landing/business-consulting/clients/01-light.svg" width="196"
                                alt="Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="border rounded-4">
                            <img class="d-block d-dark-mode-none mx-auto"
                                src="assets/img/landing/business-consulting/clients/02-dark.svg" width="196"
                                alt="Logo">
                            <img class="d-none d-dark-mode-block mx-auto"
                                src="assets/img/landing/business-consulting/clients/02-light.svg" width="196"
                                alt="Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="border rounded-4">
                            <img class="d-block d-dark-mode-none mx-auto"
                                src="assets/img/landing/business-consulting/clients/03-dark.svg" width="196"
                                alt="Logo">
                            <img class="d-none d-dark-mode-block mx-auto"
                                src="assets/img/landing/business-consulting/clients/03-light.svg" width="196"
                                alt="Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="border rounded-4">
                            <img class="d-block d-dark-mode-none mx-auto"
                                src="assets/img/landing/business-consulting/clients/05-dark.svg" width="196"
                                alt="Logo">
                            <img class="d-none d-dark-mode-block mx-auto"
                                src="assets/img/landing/business-consulting/clients/05-light.svg" width="196"
                                alt="Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="border rounded-4">
                            <img class="d-block d-dark-mode-none mx-auto"
                                src="assets/img/landing/business-consulting/clients/06-dark.svg" width="196"
                                alt="Logo">
                            <img class="d-none d-dark-mode-block mx-auto"
                                src="assets/img/landing/business-consulting/clients/06-light.svg" width="196"
                                alt="Logo">
                        </div>
                    </div>
                </div>
        ...
        <section class="container py-5 mb-1 mb-sm-2 my-lg-3 my-xl-4 my-xxl-5">
            <div class="row justify-content-center pt-2 pt-sm-4 pb-4 mb-2 mb-lg-3">
                <div class="col-lg-8 col-xl-7 col-xxl-6 text-center pt-2">
                    <h2 class="h1 mb-1">Testimonials from students who recommend Instidesk</h2>
                </div>
            </div>
            <div class="swiper pb-2 pb-sm-4"
                data-swiper-options='{
          "slidesPerView": 1,
          "spaceBetween": 24,
          "loop": true,
                    ...
                    <div class="swiper-slide h-auto">
                        <div class="card border-0 bg-info bg-opacity-10 h-100 text-center">
                            <div class="polygon-avatar bg-info mx-auto translate-middle-y">
                                <img src="assets/img/landing/mobile-app-showcase/testimonials/01.png"
                                    alt="Nick Williams">
                            </div>
                            <div class="card-body pt-0 mt-n4">
                                <p class="card-text fs-xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                    Nunc quis libero vitae sem ornare ornare. Aliquam ut sapien vitae quam blandit
                                    egestas. Quisque nulla elit, fermentum et tincidunt tempor, rutrum at leo. Curabitur
                                    massa quam, aliquam eu sapien sed.</p>
                            </div>
                    ...
                    <div class="swiper-slide h-auto">
                        <div class="card border-0 bg-warning bg-opacity-10 h-100 text-center">
                            <div class="polygon-avatar bg-warning mx-auto translate-middle-y">
                                <img src="assets/img/landing/mobile-app-showcase/testimonials/02.png"
                                    alt="Lili Bocouse">
                            </div>
                            <div class="card-body pt-0 mt-n4">
                    ...
                    <div class="swiper-slide h-auto">
                        <div class="card border-0 bg-primary bg-opacity-10 h-100 text-center">
                            <div class="polygon-avatar bg-primary mx-auto translate-middle-y">
                                <img src="assets/img/landing/mobile-app-showcase/testimonials/04.png"
                                    alt="Esther Howard">
                            </div>
                            <div class="card-body pt-0 mt-n4">
                    ...
                    <div class="swiper-slide h-auto">
                        <div class="card border-0 bg-danger bg-opacity-10 h-100 text-center">
                            <div class="polygon-avatar bg-danger mx-auto translate-middle-y">
                                <img src="assets/img/landing/mobile-app-showcase/testimonials/03.png"
                                    alt="Jane Cooper">
                            </div>
                            <div class="card-body pt-0 mt-n4">
                        ...
                        <div class="accordion" id="faq">
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="questionOne">How can i apply for international collage and
                                        university ?</button>
                                </h3>
                            ...
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button"
                                        ...
                                        aria-controls="questionTwo">How can i search relevant course for my
                                        academics ?</button>
                                </h3>
                            ...
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button"
                                        ...
                                        aria-expanded="false" aria-controls="questionThree">Will i get a consultant for counselling about my foreign studies ?</button>
                                </h3>
                            ...
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingFour">
                                    <button class="accordion-button collapsed" type="button"
                                        ...
                                        aria-expanded="false" aria-controls="questionFour">What are changes for using instidesk ?</button>
                                </h3>
                                <div class="accordion-collapse collapse" id="questionFour"
                                    aria-labelledby="headingFour" data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">Lorem ipsum dolor sit amet, consectetur
                            ...
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingFive">
                                    <button class="accordion-button collapsed" type="button"
                                        ...
                                        aria-expanded="false" aria-controls="questionFive">How many countries are there in instidesk to explore for international studies ?</button>
                                </h3>
                                <div class="accordion-collapse collapse" id="questionFive"
                                    ...
                                    <div class="accordion-body fs-sm">Vestibulum faucibus lectus eget augue pharetra,
                                        ...
                                        lacinia orci. Phasellus at varius arcu. Ut nec lobortis velit.</div>
                                </div>
                            </div>
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingSix">
                                    <button class="accordion-button collapsed" type="button"
                                        ...
                                        aria-controls="questionSix">Are there any specific criteria to apply for international courses ?</button>
                                </h3>
                            ...
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingSeven">
                                    <button class="accordion-button collapsed" type="button"
                                        ...
                                        aria-expanded="false" aria-controls="questionSeven">What if i have been rejected by a collage ones before using instidesk  ?</button>
                                </h3>
                            ...
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingSeven">
                                    <button class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#questionSeven"
                                        aria-expanded="false" aria-controls="questionSeven">How to apply or create an account on instidesk ?</button>
                                </h3>
                                <div class="accordion-collapse collapse" id="questionSeven"
                                    aria-labelledby="headingSeven" data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">Morbi a consequat diam. Fusce sit amet faucibus
        ...
        <section class="bg-dark border-top border-light py-2 py-sm-3 py-md-4 py-lg-5" data-bs-theme="dark">
            <div class="container py-5 my-lg-3 my-xl-4 my-xxl-5">
                <h2 class="h1 text-center text-md-start mt-lg-n3 pb-4 pb-md-5" style="max-width: 660px;">Instidesk is suitable for any students, wanted to study abroad</h2>
                <div class="row pt-sm-2 pt-md-0 pt-xl-1 pt-xxl-3">
                        ...
                        <div class="binded-content" style="max-width: 526px;">
                            <div class="binded-item active" id="marketers-image">
                                <div class="from-bottom">
                                    ...
                                    <img class="d-block position-relative z-2"
                                        src="assets/img/landing/saas-1/industries/01.png" alt="Image">
                                </div>
                            </div>
                            <div class="binded-item" id="agencies-image">
                                <div class="from-bottom">
                                    ...
                                    <img class="d-block position-relative z-2"
                                        src="assets/img/landing/saas-1/industries/02.png" alt="Image">
                                </div>
                            </div>
                            <div class="binded-item" id="ecommerce-image">
                                <div class="from-bottom">
                                    ...
                                    <img class="d-block position-relative z-2"
                                        src="assets/img/landing/saas-1/industries/03.png" alt="Image">
                                </div>
                            </div>
                            <div class="binded-item" id="startups-image">
                                <div class="from-bottom">
                                    ...
                                    <img class="d-block position-relative z-2"
                                        src="assets/img/landing/saas-1/industries/04.png" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 order-md-1">
                        ...
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs flex-nowrap overflow-auto text-nowrap pb-3 mb-3 mb-xl-4"
                            role="tablist">
                            <li class="nav-item mb-0">
                                <a class="nav-link active" href="#marketers-text" data-bs-toggle="tab"
                                    data-binded-content="#marketers-image" role="tab">Abroad Studies</a>
                            </li>
                            <li class="nav-item mb-0">
                                <a class="nav-link" href="#agencies-text" data-bs-toggle="tab"
                                    data-binded-content="#agencies-image" role="tab">IELTS Coaching</a>
                            </li>
                            <li class="nav-item mb-0">
                                <a class="nav-link" href="#ecommerce-text" data-bs-toggle="tab"
                                    data-binded-content="#ecommerce-image" role="tab">Counselling</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content pt-lg-2 pt-xl-3">
                            <div class="tab-pane fade show active" id="marketers-text" role="tabpanel">
                                <h3 class="mb-lg-4">Start your study abroad journey with instidesk</h3>
                                <p class="text-body">Porttitor in mauris tellus ipsum commodo praesent nunc vel integer
                                    ...
                                    pharetra gravida nunc euismod egestas quam dolor ut vel venenatis quis egestas orci.
                                </p>
                            </div>
                            <div class="tab-pane fade" id="agencies-text" role="tabpanel">
                                <h3 class="mb-lg-4">Get complete training for IELTS through best training materials and expert coaches</h3>
                            ...
                            <div class="tab-pane fade" id="ecommerce-text" role="tabpanel">
                                <h3 class="mb-lg-4">Instidesk provides dedicated Education Consultants which provides the best possible guidance to students planning to study abroad</h3>
                ...
                <div class="col-md-8 col-lg-7 col-xl-6 offset-lg-2 offset-xl-3">
                    <div class="row row-cols-1 row-cols-sm-3">
                        ...
                        <div class="col">
                            ...
                            <a class="btn btn-secondary px-3 py-2 mb-3 me-3 me-md-0" href="https://play.google.com/store/apps/details?id=com.instidesk&pcampaignid=web_share">
